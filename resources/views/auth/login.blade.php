...
<head>
    ...
    <style>
        ...
        body.dark .particle-1 { background:rgba(124,58,237,0.6); }
        body.dark .particle-2 { background:rgba(0,212,255,0.6); }
        body.dark .particle-3 { background:rgba(124,58,237,0.4); }
        body.dark .particle-4 { background:rgba(0,212,255,0.5); }
        body.dark .hex-bg { border-color: rgba(124,58,237,0.15); }
        body.dark .login-bg::before {
            background:
        ...
        body.light .particle-1 { background:rgba(124,58,237,0.4); }
        body.light .particle-2 { background:rgba(0,212,255,0.4); }
        body.light .particle-3 { background:rgba(124,58,237,0.2); }
        body.light .particle-4 { background:rgba(0,212,255,0.3); }
        body.light .hex-bg { border-color: rgba(124,58,237,0.1); }
        body.light .login-bg::before {
...
<body class="login-bg grid-pattern flex items-center justify-center min-h-screen p-4">
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        ...
                        <input type="password" name="password" id="password" required
                            ...
                            class="gaming-input" style="padding-left:2.5rem !important;padding-right:2.5rem !important;">
    ...
    <button id="theme-toggle" onclick="toggleTheme()" class="theme-toggle-btn" title="Ganti tema">
    ...
    <script>
        ...
        function toggleTheme() {
            ...
            const isDark = body.classList.contains('dark') ||
                          (window.matchMedia('(prefers-color-scheme: dark)').matches && !body.classList.contains('light'));
