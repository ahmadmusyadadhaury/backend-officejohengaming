...
@section('page-subtitle', 'Ajukan pembayaran tagihan untuk mendapatkan persetujuan')

@section('sidebar-menu')
    @php $role = auth()->user()->role; @endphp
    @include($role === 'koordinator' ? 'partials.sidebar-leader' : (in_array($role, ['admin','hr','head_of_store','gm','ceo']) ? 'partials.sidebar-admin' : 'partials.sidebar-user'))
@endsection
...
<div class="pt-2 animate-fade-in">
    <div class="max-w-2xl mx-auto">
        <div class="gaming-card p-6">
            <form method="POST" action="{{ route('payment-approval.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div id="internet-fields" class="form-grid-2" style="display:none;">
                    <div class="field-group">
                        ...
                        <input type="text" name="nama_internet" placeholder="Contoh: Wifi 1 (Kantor Utama)" class="gaming-input" value="{{ old('nama_internet') }}">
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <input type="text" name="pic" placeholder="Nama penanggung jawab" class="gaming-input" value="{{ old('pic') }}">
                    </div>
                    <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <input type="date" name="masa_tenggang" class="gaming-input" value="{{ old('masa_tenggang') }}">
                    </div>
                    <div class="field-group">
                        <label class="gaming-label">Biaya <span class="field-req">*</span></label>
                        <input type="number" name="biaya" placeholder="Contoh: 300000" class="gaming-input" min="0" step="0.01" value="{{ old('biaya') }}">
                    </div>
                </div>
                ...
                <div id="other-fields" class="form-grid-2" style="display:none;">
                    <div class="field-group">
                        ...
                        <input type="text" name="periode" id="f-periode" placeholder="Contoh: Januari 2026" class="gaming-input" value="{{ old('periode') }}">
                    </div>
                    <div class="field-group">
                        <label class="gaming-label">Nominal <span class="field-req">*</span></label>
                        <input type="number" name="nominal" placeholder="Contoh: 300000" class="gaming-input" min="0" step="0.01" value="{{ old('nominal') }}">
                    </div>
                    <div class="field-group">
                        <label class="gaming-label">Tanggal Tagihan <span class="field-req">*</span></label>
                        <input type="date" name="tanggal_tagihan" class="gaming-input" value="{{ old('tanggal_tagihan') }}">
                    </div>
                    <div class="field-group">
                ...
                <div class="field-group mb-5">
                    ...
                    <input type="date" name="tanggal_bayar" required class="gaming-input" value="{{ old('tanggal_bayar', date('Y-m-d')) }}">
