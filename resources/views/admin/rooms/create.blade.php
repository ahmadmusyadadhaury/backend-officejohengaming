...
<div class="pt-2 max-w-lg animate-fade-in">
    <div class="gaming-card p-6">
        <form method="POST" action="{{ route('admin.rooms.store') }}" class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_weekly_only" id="is_weekly_only" value="1" {{ old('is_weekly_only') ? 'checked' : '' }} style="width:14px;height:14px;accent-color:var(--color-accent);cursor:pointer;">
