                ...
                <tbody id="vehicles-tbody">
                    ...
                    <tr data-status="{{ $v->status_pajak }}">
                        ...
                        <td class="hidden lg:table-cell" style="color:var(--text-muted);font-family:monospace;font-size:12px;">
                            @if($v->nomor_rangka){{ $v->nomor_rangka }}@else<svg class="w-4 h-4 inline-block align-middle" style="color:#f59e0b;" fill="currentColor" viewBox="0 0 20 20" title="Belum diinput"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>@endif
                        </td>
                        <td class="hidden lg:table-cell" style="color:var(--text-muted);font-family:monospace;font-size:12px;">
                        ...
                        <td class="hidden lg:table-cell">
                            ...
                            <a href="{{ url('storage/'.$v->foto) }}" target="_blank" rel="noopener">
                                <img src="{{ url('storage/'.$v->foto) }}" alt="Foto" style="width:60px;height:40px;border-radius:6px;object-fit:cover;border:1px solid var(--border-color);">
                            </a>
                            @else
                            <svg class="w-5 h-5" style="color:#f59e0b;" fill="currentColor" viewBox="0 0 20 20" title="Belum diinput"><path fill-rule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/></svg>
                            @endif
                        </td>
