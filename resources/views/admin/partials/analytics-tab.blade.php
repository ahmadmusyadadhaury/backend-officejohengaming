...
<div class="analytics-wrapper space-y-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {{-- Chart 1: Mixed (Bar + Line) Bulanan --}}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {{-- Chart 3: Horizontal Bar 10 Produk Terlaris --}}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {{-- Chart 5: Treemap Penjualan / Kategori --}}
