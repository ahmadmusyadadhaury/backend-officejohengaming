        ...
        <form method="POST" action="{{ route('admin.weekly-meetings.update', $weekly) }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="time" name="start_time" value="{{ old('start_time', substr($weekly->start_time,0,5)) }}" required class="gaming-input">
                </div>
                <div>
                    <label class="gaming-label">Jam Selesai <span style="color:#f87171;">*</span></label>
                    <input type="time" name="end_time" value="{{ old('end_time', substr($weekly->end_time,0,5)) }}" required class="gaming-input">
                </div>
            </div>
