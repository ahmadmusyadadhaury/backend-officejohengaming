        ...
        <div class="gaming-card p-4 animate-fade-in">
            <div class="flex items-start justify-between mb-3">
                <div class="min-w-0">
                    ...
                    <p class="text-xs mt-0.5" style="color:var(--color-neon-blue);">{{ $weekly->room->name }}</p>
                </div>
                <span class="badge {{ $weekly->is_active ? 'badge-green' : 'badge-red' }} flex-shrink-0">
            ...
            <div class="space-y-2 mb-4">
                <div class="flex items-center gap-2 p-2 rounded-lg" style="background:var(--bg-surface-2);">
                    ...
                    <span class="text-sm" style="color:var(--text-primary);">Setiap <strong>{{ $days[$weekly->day_of_week] ?? '-' }}</strong></span>
                </div>
                <div class="flex items-center gap-2 p-2 rounded-lg" style="background:var(--bg-surface-2);">
