    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Seluruh aset tim perusahaan</div>
            </div>
        </div>
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Aset tim yang masih aktif</div>
            </div>
        </div>
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Aset tim yang tidak aktif</div>
            </div>
        </div>
    </div>
        ...
        <div class="table-responsive">
            <table class="gaming-table min-w-[700px]" id="aset-table">
                ...
                <tbody id="aset-tbody">
                    ...
                    @empty
                    <tr><td colspan="8" style="text-align:center;padding:2rem;color:var(--text-muted);">Belum ada data aset tim.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
