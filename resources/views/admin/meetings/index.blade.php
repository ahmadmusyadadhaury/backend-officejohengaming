        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3"><span class="px-2 py-0.5 rounded-full text-xs font-medium {{ $statusColors[$meeting->status] ?? 'bg-gray-100 text-gray-600' }}">{{ ucfirst($meeting->status) }}</span></td>
                    <td class="px-4 py-3">
                ...
                @empty
                <tr><td colspan="7" class="px-4 py-8 text-center text-gray-400">Belum ada permintaan meeting.</td></tr>
                @endforelse
            </tbody>
        </table>
