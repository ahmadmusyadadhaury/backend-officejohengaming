    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div class="min-w-0">
                ...
                <div class="text-[11px] font-medium mt-0.5" style="color:var(--text-primary);">Total Rekaman</div>
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Seluruh rekap rapat</div>
            </div>
        </div>
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                <div class="text-xl font-gaming font-bold" style="color:#60a5fa;">{{ $stats['this_month'] }}</div>
                <div class="text-[11px] font-medium mt-0.5" style="color:var(--text-secondary);">Bulan Ini</div>
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Rekaman {{ now()->locale('id')->isoFormat('MMMM YYYY') }}</div>
            </div>
        </div>
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                <div class="text-xl font-gaming font-bold" style="color:#34d399;">{{ $stats['finalized'] }}</div>
                <div class="text-[11px] font-medium mt-0.5" style="color:var(--text-secondary);">Final</div>
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Sudah difinalisasi</div>
            </div>
        </div>
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                <div class="text-xl font-gaming font-bold" style="color:#fbbf24;">{{ $stats['draft'] }}</div>
                <div class="text-[11px] font-medium mt-0.5" style="color:var(--text-secondary);">Draft</div>
                <div class="text-[11px] mt-0.5 leading-tight" style="color:var(--text-muted);">Belum difinalisasi</div>
            </div>
        </div>
    </div>
