...
<div class="pt-2 space-y-4 animate-fade-in">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2.5 md:gap-3">
        <div class="stat-card-compact">
            ...
            <div>
                <div class="stat-num" style="color:var(--text-primary);">{{ $momStats['total_moms'] }}</div>
        ...
        <div class="stat-card-compact">
            ...
            <div>
                <div class="stat-num" style="color:#34d399;">{{ $momStats['sent_moms'] }}</div>
                <div class="stat-label-text" style="font-size:0.7rem;">Terkirim</div>
            </div>
        </div>
        <div class="stat-card-compact">
            ...
            <div>
                <div class="stat-num" style="color:#fbbf24;">{{ $momStats['draft_moms'] }}</div>
    ...
    <div class="gaming-card overflow-hidden">
        ...
        <div class="px-6 py-2.5 flex flex-wrap items-center gap-3" style="border-bottom:1px solid var(--border-color);">
            <div class="relative flex-1 min-w-[200px] max-w-[260px]">
                ...
                <form method="GET" action="{{ route('koordinator.mom.index') }}">
