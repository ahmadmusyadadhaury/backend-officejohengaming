...
<div class="pt-2 max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm p-6">
        ...
        <form method="POST" action="{{ route('leader.meetings.mom.store', $meeting) }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <div>
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('leader.meetings.show', $meeting) }}" class="px-5 py-2 bg-gray-100 text-gray-600 rounded-lg text-sm hover:bg-gray-200 transition">Batal</a>
            </div>
        </form>
    </div>
</div>
