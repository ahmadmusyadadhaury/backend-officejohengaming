...
<div class="pt-2 max-w-lg">
    <div class="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center">
        ...
        <a href="{{ route('leader.meetings.show', $meeting) }}" class="inline-block mt-4 px-4 py-2 bg-primary text-white rounded-lg text-sm hover:bg-primary-light transition">Kembali ke Detail</a>
    </div>
</div>
@endsection
