...
<body style="font-family:sans-serif;background:#f4f4f4;padding:40px;">
    <div style="max-width:520px;margin:auto;background:#fff;border-radius:12px;padding:32px;">
        ...
        <p style="margin:0 0 12px;font-size:14px;color:#555;">
            Pemberitahuan: Pemakaian listrik telah mencapai <strong style="color:#dc2626;">{{ number_format($usedKwh, 0) }} kWh</strong> atau sisa token listrik diperkirakan <strong style="color:#dc2626;">{{ $remainingKwh }} kWh</strong>.
        </p>
        <p style="margin:0 0 16px;font-size:14px;color:#555;">
            Mohon segera melakukan pengisian token listrik untuk menghindari gangguan operasional.
        </p>
