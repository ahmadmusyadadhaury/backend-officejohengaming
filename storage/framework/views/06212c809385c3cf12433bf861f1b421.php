...
<?php $__env->startSection('title', 'Edit MOM'); ?>
<?php $__env->startSection('page-title', 'Edit Minutes of Meeting'); ?>
...
<div class="pt-2 max-w-2xl animate-fade-in">
    <div class="gaming-card p-6">
        <form method="POST" action="<?php echo e(route('koordinator.mom.update', $mom)); ?>" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
            <div>
                <label class="gaming-label">Ringkasan Pembahasan <span style="color:#f87171;">*</span></label>
                <textarea name="summary" rows="3" required class="gaming-input" style="resize:vertical;"><?php echo e(old('summary', $mom->summary)); ?></textarea>
            </div>
            <div>
                <label class="gaming-label">Keputusan <span style="color:#f87171;">*</span></label>
                <textarea name="decisions" rows="3" required class="gaming-input" style="resize:vertical;"><?php echo e(old('decisions', $mom->decisions)); ?></textarea>
            </div>
            <div>
                <label class="gaming-label">Action Plan <span style="color:#f87171;">*</span></label>
                <textarea name="action_plan" rows="3" required class="gaming-input" style="resize:vertical;"><?php echo e(old('action_plan', $mom->action_plan)); ?></textarea>
            </div>
            <div>
                <label class="gaming-label">PIC <span style="color:#f87171;">*</span></label>
                <input type="text" name="pic" value="<?php echo e(old('pic', $mom->pic)); ?>" required class="gaming-input">
            </div>
            <div>
                ...
                <div class="flex items-center gap-2 mb-2 p-2 rounded-lg" style="background:var(--bg-surface-2);border:1px solid var(--border-color);">
                    ...
                    <a href="<?php echo e(asset('storage/'.$mom->file_path)); ?>" target="_blank" class="text-sm font-medium" style="color:var(--color-accent-light);">File saat ini</a>
                </div>
                <?php endif; ?>
            ...
            <div class="flex gap-3 pt-2" style="border-top:1px solid var(--border-color);">
                ...
                <a href="<?php echo e(route('koordinator.meetings.show', $mom->meeting_id)); ?>" class="btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\leader\mom\edit.blade.php ENDPATH**/ ?>