...
<body style="font-family:sans-serif;background:#f4f4f4;padding:40px;">
    <div style="max-width:520px;margin:auto;background:#fff;border-radius:12px;padding:32px;">
        <div style="text-align:center;margin-bottom:24px;">
            <img src="<?php echo e(asset('images/logo/logo_web.png')); ?>" alt="Johen Office" style="height:48px;width:auto;">
        </div>
        <p style="margin:0 0 12px;font-size:14px;color:#333;">Yth. Pengguna,</p>
        <p style="margin:0 0 12px;font-size:14px;color:#555;">
            Pemberitahuan: Pemakaian listrik telah mencapai
            <strong style="color:<?php echo e($level === 'danger' ? '#dc2626' : '#d97706'); ?>;"><?php echo e(number_format($usedKwh, 0)); ?> kWh</strong>
            dari kapasitas <?php echo e(number_format($capacityKwh, 0)); ?> kWh.
        </p>
        <p style="margin:0 0 12px;font-size:14px;color:#555;">
            Sisa token listrik diperkirakan
            <strong style="color:<?php echo e($level === 'danger' ? '#dc2626' : '#d97706'); ?>;"><?php echo e($remainingKwh); ?> kWh</strong>.
        </p>
        ...
        <a href="<?php echo e($url); ?>" style="display:inline-block;padding:10px 20px;background:#6c5cff;color:#fff;text-decoration:none;border-radius:8px;font-size:14px;">Kelola Token Listrik</a>
        <p style="margin-top:24px;font-size:12px;color:#999;">Email ini dikirim otomatis oleh Johen Office System.</p>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\emails\token-low.blade.php ENDPATH**/ ?>