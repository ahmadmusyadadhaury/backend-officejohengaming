                ...
                <tbody id="vehicles-tbody">
                    ...
                    <tr data-status="<?php echo e($v->status_pajak); ?>">
                        ...
                        <td class="hidden lg:table-cell" style="vertical-align:middle;font-size:12px;">
                            <?php if($v->foto): ?>
                            <a href="<?php echo e(url('storage/'.$v->foto)); ?>" target="_blank" rel="noopener">
                                <img src="<?php echo e(url('storage/'.$v->foto)); ?>" alt="Foto" style="width:60px;height:40px;border-radius:6px;object-fit:cover;border:1px solid var(--border-color);display:block;">
                            </a>
                            <?php else: ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-officejohengaming\resources\views/admin/vehicles/index.blade.php ENDPATH**/ ?>