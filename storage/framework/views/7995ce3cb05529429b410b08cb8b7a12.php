...
<?php $__env->startSection('title', 'Buat MOM'); ?>
<?php $__env->startSection('page-title', 'Buat Minutes of Meeting'); ?>
    ...
    <div class="gaming-card p-6">
        <div class="flex items-center gap-2 mb-4 p-3 rounded-lg" style="background:var(--bg-surface-2);border:1px solid var(--border-color);">
            ...
            <p class="text-sm" style="color:var(--text-secondary);">
                <span style="color:var(--text-primary);font-weight:600;"><?php echo e($meeting->title); ?></span>
                · <?php echo e($meeting->meeting_date->format('d M Y')); ?>

            </p>
        </div>
        <form method="POST" action="<?php echo e(route('koordinator.meetings.mom.store', $meeting)); ?>" enctype="multipart/form-data" class="space-y-4">
            <?php echo csrf_field(); ?>
            <div>
                <label class="gaming-label">Ringkasan Pembahasan <span style="color:#f87171;">*</span></label>
                <textarea name="summary" rows="3" required class="gaming-input" style="resize:vertical;"><?php echo e(old('summary')); ?></textarea>
            </div>
            <div>
                <label class="gaming-label">Keputusan <span style="color:#f87171;">*</span></label>
                <textarea name="decisions" rows="3" required class="gaming-input" style="resize:vertical;"><?php echo e(old('decisions')); ?></textarea>
            </div>
            <div>
                <label class="gaming-label">Action Plan <span style="color:#f87171;">*</span></label>
                <textarea name="action_plan" rows="3" required class="gaming-input" style="resize:vertical;"><?php echo e(old('action_plan')); ?></textarea>
            </div>
            <div>
                <label class="gaming-label">Penanggung Jawab (PIC) <span style="color:#f87171;">*</span></label>
                <input type="text" name="pic" value="<?php echo e(old('pic')); ?>" required placeholder="Nama penanggung jawab" class="gaming-input">
            </div>
            <div>
            ...
            <div class="flex gap-3 pt-2" style="border-top:1px solid var(--border-color);">
                ...
                <a href="<?php echo e(route('koordinator.meetings.show', $meeting)); ?>" class="btn btn-secondary">Batal</a>
            </div>
        </form>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\leader\mom\create.blade.php ENDPATH**/ ?>