        ...
        <div class="gaming-card">
            <div class="card-body">
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    ...
                    <a href="<?php echo e(route('koordinator.meetings.index')); ?>?open_request=1" class="btn btn-primary btn-sm flex-shrink-0">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views/leader/dashboard.blade.php ENDPATH**/ ?>