...
<?php $__env->startSection('title', 'Edit Meeting Mingguan'); ?>
<?php $__env->startSection('page-title', 'Edit Jadwal Meeting Mingguan'); ?>
...
<div class="pt-2 max-w-lg animate-fade-in">
    <div class="gaming-card p-6">
        <form method="POST" action="<?php echo e(route('admin.weekly-meetings.update', $weekly)); ?>" class="space-y-4">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
            <div>
                <label class="gaming-label">Judul <span style="color:#f87171;">*</span></label>
                <input type="text" name="title" value="<?php echo e(old('title', $weekly->title)); ?>" required class="gaming-input">
            </div>
            <div>
                ...
                <select name="room_id" required class="gaming-input gaming-select">
                    <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($room->id); ?>" <?php echo e($weekly->room_id == $room->id ? 'selected' : ''); ?>><?php echo e($room->name); ?></option>
            ...
            <div>
                ...
                <select name="day_of_week" required class="gaming-input gaming-select">
                    <?php $__currentLoopData = [1=>'Senin',2=>'Selasa',3=>'Rabu',4=>'Kamis',5=>'Jumat',6=>'Sabtu',7=>'Minggu']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($val); ?>" <?php echo e($weekly->day_of_week == $val ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="start_time" id="weekly-start" value="<?php echo e(old('start_time', substr($weekly->start_time,0,5))); ?>" required class="gaming-input" placeholder="--:--" autocomplete="off">
                </div>
                <div>
                    <label class="gaming-label">Jam Selesai <span style="color:#f87171;">*</span></label>
                    <input type="text" name="end_time" id="weekly-end" value="<?php echo e(old('end_time', substr($weekly->end_time,0,5))); ?>" required class="gaming-input" placeholder="--:--" autocomplete="off">
                </div>
            </div>
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_active" id="is_active" value="1" <?php echo e($weekly->is_active ? 'checked' : ''); ?> style="width:14px;height:14px;accent-color:var(--color-accent);cursor:pointer;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\admin\weekly\edit.blade.php ENDPATH**/ ?>