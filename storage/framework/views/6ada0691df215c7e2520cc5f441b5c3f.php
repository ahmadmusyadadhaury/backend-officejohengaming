...
<?php $__env->startSection('title', 'Aset MES Saya'); ?>
<?php $__env->startSection('page-title', 'Operasional > Aset MES'); ?>
<?php $__env->startSection('page-subtitle', 'Daftar aset MES yang menjadi tanggung jawab saya'); ?>
<?php $__env->startSection('sidebar-menu'); ?> <?php echo $__env->make('partials.sidebar-leader', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?> <?php $__env->stopSection(); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-1">
                                <button type="button" onclick="openEditModal(<?php echo e($a->id); ?>)" class="btn btn-secondary btn-sm" style="padding:3px 8px;font-size:0.7rem;">Edit</button>
                                <form method="POST" action="<?php echo e(route('koordinator.aset-mes.destroy', $a)); ?>" onsubmit="confirmSubmit(event, this)" data-confirm="Hapus aset ini?" style="margin:0;">
...
function openCreateModal() {
    ...
    document.getElementById('aset-form').action = '<?php echo e(route("koordinator.aset-mes.index")); ?>';
...
function openEditModal(id) {
    ...
    document.getElementById('aset-form').action = '<?php echo e(route("koordinator.aset-mes.update", ["asetMes" => "___ID___"])); ?>'.replace('___ID___', id);
...
<script>
const assets = <?php echo json_encode($assets->values()->map(fn($a) => [
    'id' => $a->id, 'nama_aset' => $a->nama_aset, 'jumlah' => $a->jumlah) ?>;
</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\leader\aset-mes\index.blade.php ENDPATH**/ ?>