                    ...
                    <div class="relative">
                        <button type="button" class="topbar-profile-btn" onclick="this.parentElement.querySelector('[data-profile-dropdown]').classList.toggle('hidden')">
                            <?php if(auth()->user()->avatar_url): ?>
                                <span class="topbar-profile-avatar"><img src="<?php echo e(auth()->user()->avatar_url); ?>?v=<?php echo e(time()); ?>" alt="" class="topbar-avatar-img"></span>
                            <?php else: ?>
                        ...
                        <div data-profile-dropdown class="hidden absolute right-0 top-12 w-48 rounded-xl z-50 topbar-dropdown"
                            ...
                            <div class="flex items-center gap-3 px-4 py-3 border-b" style="border-color:var(--border-color);">
                                <div class="dropdown-avatar-wrapper flex-shrink-0">
                                    <?php if(auth()->user()->avatar_url): ?>
                                        <img src="<?php echo e(auth()->user()->avatar_url); ?>?v=<?php echo e(time()); ?>" alt="" class="dropdown-avatar-img">
                                    <?php else: ?>
                                        <span class="dropdown-avatar-initials"><?php echo e(strtoupper(substr(auth()->user()->name, 0, 2))); ?></span>
                                    <?php endif; ?>
                                </div>
                                <div class="min-w-0">
                                    <p class="text-sm font-semibold truncate" style="color:var(--text-primary);"><?php echo e(auth()->user()->name); ?></p>
                                    <p class="text-xs truncate" style="color:var(--text-muted);"><?php echo e(auth()->user()->username); ?></p>
                                </div>
                            </div>
