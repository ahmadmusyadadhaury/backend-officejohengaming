        ...
        <div class="login-card p-8">
            ...
            <div class="space-y-3">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-primary w-full">
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('rooms.index')); ?>" class="btn btn-success w-full">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5"/>
                        </svg>
                        Lihat Ruangan
                    </a>
                    <a href="<?php echo e(route('bookings.index')); ?>" class="btn btn-secondary w-full">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\welcome.blade.php ENDPATH**/ ?>