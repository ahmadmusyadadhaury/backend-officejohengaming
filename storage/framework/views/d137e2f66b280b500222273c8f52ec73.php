...
<script>
    ...
    function loadConversations() {
        fetch('<?php echo e(route("admin.chat.conversations")); ?>')
            .then(r => r.json())
            .then(data => {
    ...
    function loadMessages(userId) {
        ...
        fetch('<?php echo e(route("admin.chat.messages")); ?>?with=' + userId)
            .then(r => r.json())
            .then(data => {
                container.innerHTML = '';
    ...
    function appendMessage(m) {
        var container = document.getElementById('chat-messages');
        var isMine = m.sender_id === <?php echo e(auth()->id()); ?>;
    ...
    function startPolling() {
        ...
        chatState.pollingInterval = setInterval(function() {
            if (chatState.activeUserId) {
                fetch('<?php echo e(route("admin.chat.messages")); ?>?with=' + chatState.activeUserId + '&t=' + Date.now())
                    .then(r => r.json())
                    .then(function(data) {
                        var container = document.getElementById('chat-messages');
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\admin\partials\chat-tab.blade.php ENDPATH**/ ?>