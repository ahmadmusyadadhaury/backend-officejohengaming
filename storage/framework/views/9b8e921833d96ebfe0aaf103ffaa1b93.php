...
<?php $__env->startSection('title', 'Aset Ruko'); ?>
<?php $__env->startSection('page-title', 'Data Aset > Milik Ruko'); ?>
<?php $__env->startSection('page-subtitle', 'Seluruh aset ruko milik perusahaan'); ?>
...
<div class="pt-2 space-y-4 animate-fade-in">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div class="min-w-0">
                <div id="stat-total" class="text-xl font-gaming font-bold" style="color:var(--text-primary);"><?php echo e($stats['total']); ?></div>
        ...
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                <div id="stat-baik" class="text-xl font-gaming font-bold" style="color:#34d399;"><?php echo e($stats['kondisi_baik']); ?></div>
        ...
        <div class="gaming-card p-4 flex items-center gap-3">
            ...
            <div>
                <div id="stat-perlu" class="text-xl font-gaming font-bold" style="color:#fbbf24;"><?php echo e($stats['perlu_servis']); ?></div>
    ...
    <?php $perluCount = $alertJson->count(); ?>
    <?php if($perluCount > 0): ?>
    <div>
        <div class="flex items-start gap-3 px-5 py-3.5 rounded-2xl" style="background:rgba(245,158,11,0.08);border:1px solid rgba(245,158,11,0.2);">
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm font-bold" style="color:#f59e0b;"><?php echo e($perluCount); ?> Aset Ruko Perlu Servis</div>
                <div class="text-xs mt-1" style="color:var(--text-secondary);"><?php echo e($perluCount); ?> aset ruko perlu perbaikan atau servis.</div>
            </div>
        ...
        <div class="table-responsive">
            <table class="gaming-table min-w-[600px]" id="ruko-table">
                ...
                <tbody id="ruko-tbody">
                    ...
                    ?>
                    <tr data-id="<?php echo e($i->id); ?>" data-kondisi="<?php echo e($i->kondisi); ?>">
                        <td style="color:var(--text-muted);"><?php echo e($loop->iteration); ?></td>
                        <td style="color:var(--text-primary);font-weight:500;"><?php echo e($i->nama_aset); ?></td>
                        <td class="hidden md:table-cell" style="color:var(--text-muted);"><?php echo e($i->lokasi); ?></td>
                        <td><span class="badge badge-cyan"><?php echo e($i->jumlah); ?></span></td>
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                <div class="dropdown-wrap" style="position:relative;">
                                    ...
                                    <div id="dropdown-<?php echo e($i->id); ?>" class="dropdown-menu" style="display:none;position:absolute;top:100%;right:0;z-index:99999;min-width:130px;background:var(--bg-surface);border:1px solid var(--border-color);border-radius:10px;padding:4px;box-shadow:0 8px 24px rgba(0,0,0,0.15);margin-top:4px;">
                                        ...
                                        <form method="POST" action="<?php echo e(route('admin.ruko.destroy', $i)); ?>" onsubmit="confirmSubmit(event, this)" data-confirm="Hapus aset ruko ini?" style="margin:0;">
...
<script>
const rukoData = <?php echo json_encode($itemsJson, 15, 512) ?>;
...
function openCreateModal() {
    ...
    document.getElementById('ruko-form').action = '<?php echo e(route('admin.ruko.store')); ?>';
...
function openEditModal(id) {
    ...
    document.getElementById('ruko-form').action = '<?php echo e(url('admin/ruko')); ?>/' + i.id;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views/admin/ruko/index.blade.php ENDPATH**/ ?>