...
<?php $__env->startSection('title', 'Aset Saya'); ?>
<?php $__env->startSection('page-title', 'Aset Saya'); ?>
<?php $__env->startSection('page-subtitle', 'Daftar aset daya yang menjadi tanggung jawab saya'); ?>
...
<div class="pt-2 space-y-4 animate-fade-in">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        ?>
        <?php $__currentLoopData = $dsStatCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <table class="gaming-table min-w-[800px]">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span style="color:var(--text-secondary);"><?php echo e($a->jenis_aset ?? '-'); ?></span></td>
                        <td><span style="color:var(--text-secondary);"><?php echo e($a->keterangan ? Str::limit($a->keterangan, 40) : '-'); ?></span></td>
                        <td><span style="color:var(--text-secondary);"><?php echo e($a->daya ? $a->daya . ($a->unit ? ' ' . $a->unit : '') : '-'); ?></span></td>
                        <td>
                            <div class="flex items-center gap-1">
                                ...
                                <form method="POST" action="<?php echo e(route('koordinator.data-saya.destroy', $a)); ?>" onsubmit="confirmSubmit(event, this)" data-confirm="Hapus aset ini?">
...
<div id="addModal" class="modal-modern" onclick="if(event.target===this)closeAddModal()">
    <div class="modal-modern-panel md" onclick="event.stopPropagation()">
        ...
        <form method="POST" action="<?php echo e(route('koordinator.data-saya.store')); ?>">
            <?php echo csrf_field(); ?>
...
function openEditModal(asset) {
    document.getElementById('editForm').action = '<?php echo e(route("koordinator.data-saya.update", ["asetDaya" => "___ID___"])); ?>'.replace('___ID___', asset.id);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views/leader/data-saya/index.blade.php ENDPATH**/ ?>