<?php $__env->startSection('title', 'Jadwal Meeting'); ?>
<?php $__env->startSection('page-title', 'Jadwal Meeting'); ?>
<?php $__env->startSection('page-subtitle', 'Lihat jadwal semua meeting'); ?>
        ...
        <aside class="cal-sidebar hidden lg:flex">
            ...
            <div id="weekly-panel" class="cal-sidebar-panel" style="border-color:rgba(0,212,255,0.25);background:linear-gradient(135deg,rgba(0,212,255,0.05),rgba(124,58,237,0.05));">
                <div class="cal-sidebar-panel-header flex items-center justify-between" style="border-bottom-color:rgba(0,212,255,0.15);">
                    ...
                    <?php if(in_array(auth()->user()->role, ['admin', 'hr'])): ?>
                    <div class="flex items-center gap-1">
                        <button type="button" onclick="openWeeklyEdit(<?php echo e($wm?->id ?? 0); ?>)" class="p-1 rounded-lg transition" style="color:var(--text-muted);background:none;border:none;cursor:pointer;" onmouseover="this.style.color='var(--color-neon-blue)'" onmouseout="this.style.color='var(--text-muted)'">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                            </svg>
                        </button>
                        <button type="button" onclick="deleteWeekly(<?php echo e($wm?->id ?? 0); ?>)" class="p-1 rounded-lg transition" style="color:var(--text-muted);background:none;border:none;cursor:pointer;" onmouseover="this.style.color='#ef4444'" onmouseout="this.style.color='var(--text-muted)'">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-3 space-y-2">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <p id="weekly-panel-title" class="text-sm font-semibold" style="color:var(--text-primary);"><?php echo e($wm->title); ?></p>
                    </div>
                    <div class="space-y-1">
                            <p id="weekly-panel-day" class="flex items-center gap-1.5 text-xs" style="color:var(--text-secondary);">
                                ...
                                Setiap <span id="weekly-panel-day-text"><?php echo e($days[$wm->day_of_week] ?? 'Hari'); ?></span>
                            </p>
                            <p id="weekly-panel-time" class="flex items-center gap-1.5 text-xs" style="color:var(--text-secondary);">
                                <svg class="w-3.5 h-3.5 flex-shrink-0" style="color:var(--color-neon-blue);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                                <span id="weekly-panel-time-text"><?php echo e(substr($wm->start_time, 0, 5)); ?> – <?php echo e(substr($wm->end_time, 0, 5)); ?></span>
                            </p>
                            <p id="weekly-panel-room" class="flex items-center gap-1.5 text-xs" style="color:var(--text-secondary);">
                                ...
                                <span id="weekly-panel-room-text"><?php echo e($wm->room->name ?? '-'); ?></span>
                            </p>
                    </div>
                    <?php else: ?>
                    <div class="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <div style="position:relative;">
                            <select name="day_of_week" id="we-day" required class="w-full px-3 py-2 rounded-xl text-sm" style="appearance:none;-webkit-appearance:none;border:1px solid var(--border-color);background:var(--bg-surface-2);color:var(--text-primary);outline:none;padding-right:2rem;">
                                <?php $__currentLoopData = $days; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    var firstRoomId = <?php echo e($rooms->first()?->id ?? 'null'); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\calendar.blade.php ENDPATH**/ ?>