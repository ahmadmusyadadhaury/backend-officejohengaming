...
<?php $__env->startSection('page-title', 'Tambah Akun Admin'); ?>
        ...
        <form method="POST" action="<?php echo e(route('admin.admins.store')); ?>" class="space-y-4">
            ...
            <div>
                ...
                <select name="role" required class="gaming-input gaming-select">
                    ...
                    <option value="admin"         <?php echo e(old('role') === 'admin'         ? 'selected' : ''); ?>>Admin Master</option>
                    <option value="head_of_store" <?php echo e(old('role') === 'head_of_store' ? 'selected' : ''); ?>>Head of Store</option>
                    <option value="gm"            <?php echo e(old('role') === 'gm'            ? 'selected' : ''); ?>>General Manager (GM)</option>
                    <option value="ceo"           <?php echo e(old('role') === 'ceo'           ? 'selected' : ''); ?>>Chief Executive Officer (CEO)</option>
                    <option value="hr"            <?php echo e(old('role') === 'hr'            ? 'selected' : ''); ?>>HR (Human Resources)</option>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\admin\admins\create.blade.php ENDPATH**/ ?>