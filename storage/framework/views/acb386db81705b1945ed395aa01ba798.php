                    ...
                    <tr data-meeting-id="<?php echo e($meeting->id); ?>" data-status="<?php echo e($meeting->status); ?>" data-title="<?php echo e(strtolower($meeting->title)); ?>" class="meeting-row">
                        ...
                        <td>
                            <div class="flex items-center gap-1" style="white-space:nowrap;">
                                <button type="button" onclick="showDetail(<?php echo e($meeting->id); ?>)" class="btn btn-secondary btn-sm" style="display:inline-flex;align-items:center;gap:2px;padding:3px 6px;font-size:0.65rem;" title="Lihat detail">
                                ...
                                <div class="dropdown-wrap" style="position:relative;">
                                    ...
                                    <div id="dropdown-<?php echo e($meeting->id); ?>" class="dropdown-menu" style="display:none;position:absolute;top:100%;right:0;z-index:99999;min-width:130px;background:var(--bg-surface);border:1px solid var(--border-color);border-radius:10px;padding:4px;box-shadow:0 8px 24px rgba(0,0,0,0.15);margin-top:4px;">
                                        <button type="button" onclick="showDetail(<?php echo e($meeting->id); ?>)" style="display:block;width:100%;text-align:left;padding:6px 10px;border:none;background:none;font-size:12px;color:var(--text-primary);border-radius:6px;cursor:pointer;" onmouseover="this.style.background='var(--bg-surface-2)'" onmouseout="this.style.background='none'">Detail</button>
...
<div id="request-modal" style="display:none;position:fixed;inset:0;z-index:99999;align-items:center;justify-content:center;padding:16px;overflow-y:auto;background:var(--bg-overlay);backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);">
    <div class="w-full max-w-[820px] rounded-3xl shadow-2xl flex flex-col" style="background:var(--bg-surface);" onclick="event.stopPropagation()">
        ...
        <form method="POST" action="<?php echo e(route('koordinator.meetings.store')); ?>" enctype="multipart/form-data" class="px-6 py-5 space-y-4 overflow-y-auto flex-1">
            <?php echo csrf_field(); ?>
