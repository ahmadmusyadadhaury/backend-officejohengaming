...
function openCreateModal() {
    ...
    document.getElementById('aset-form').action = '<?php echo e(route("admin.aset-tim.index")); ?>';
...
function openEditModal(id) {
    ...
    document.getElementById('aset-form').action = '<?php echo e(url("admin/aset-tim")); ?>/' + a.id;
