...
<?php $__env->startSection('title', 'Status Pengajuan'); ?>
<?php $__env->startSection('page-title', 'Status Pengajuan Pembayaran'); ?>
<?php $__env->startSection('page-subtitle', 'Riwayat pengajuan pembayaran kamu'); ?>
        ...
        <div class="table-responsive">
            <table class="gaming-table" style="width:100%;min-width:700px;">
                ...
                <tbody id="status-tbody">
                    ...
                    <tr data-status="<?php echo e($r['status']); ?>">
                        ...
                        <td style="color:var(--text-secondary);font-size:13px;"><?php echo e($r['tanggal_bayar']); ?></td>
                        <td>
                            ...
                            <?php else: ?>
                                <span class="badge badge-yellow"><?php echo e(ucfirst($r['status'])); ?></span>
                            <?php endif; ?>
                        </td>
                        <td>
                            <?php if($r['bukti_url']): ?>
                            <a href="<?php echo e($r['bukti_url']); ?>" target="_blank" class="text-xs font-semibold" style="color:#6c5cff;">Lihat</a>
                            <?php else: ?>
                        ...
                        <td class="hidden md:table-cell" style="font-size:12px;color:var(--text-secondary);">
                            <?php if($r['status'] === 'lunas'): ?>
                                <?php echo e($r['approver_name'] ?? '-'); ?><br><span style="font-size:11px;"><?php echo e($r['approved_at']); ?></span>
                            <?php elseif($r['status'] === 'rejected' && $r['notes']): ?>
                                <span style="color:#ef4444;"><?php echo e($r['notes']); ?></span>
                            <?php else: ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views/payment-approval/status.blade.php ENDPATH**/ ?>