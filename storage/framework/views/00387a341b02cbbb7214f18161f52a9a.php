...
<div class="pt-2 space-y-5 animate-fade-in">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <?php $idx = 0; ?>
        <?php $__currentLoopData = $stats['platforms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $platform => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $colors = platformColors($platform, $platformBrand, $fallbackColors, $fallbackBgs);
                $idx++;
            ?>
            <div class="stat-card-compact">
                <div class="stat-icon-box" style="background:<?php echo e($colors['bg']); ?>;">
                    <svg style="color:<?php echo e($colors['text']); ?>;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"/>
                    </svg>
                </div>
                <div class="min-w-0">
                    <div class="stat-num" style="color:<?php echo e($colors['text']); ?>;"><?php echo e($count); ?></div>
                    <div class="stat-label-text"><?php echo e($platform); ?></div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-officejohengaming\resources\views/admin/sosial-media/index.blade.php ENDPATH**/ ?>