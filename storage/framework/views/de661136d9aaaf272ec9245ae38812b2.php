...
<?php $__env->startSection('page-title', 'Detail Permintaan Meeting'); ?>
...
<div class="pt-2 max-w-3xl space-y-4 animate-fade-in">
        ...
        <div class="flex items-start justify-between gap-4">
            <div>
                ...
                <p class="text-sm mt-1" style="color:var(--text-muted);">
                    Oleh: <?php echo e($meeting->requester->name); ?> · <span style="color:var(--color-accent-light);"><?php echo e($meeting->team->name); ?></span>
                    <?php if($meeting->teams->count()): ?> <?php $__currentLoopData = $meeting->teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> + <?php echo e($t->name); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php endif; ?>
                </p>
            </div>
            <?php $sb = match($meeting->status) {'pending'=>'badge-yellow','approved'=>'badge-blue','rejected'=>'badge-red','confirmed'=>'badge-primary','cancelled'=>'badge-gray','in_progress'=>'badge-primary','completed'=>'badge-green',default=>'badge-gray'}; ?>
            <span class="badge <?php echo e($sb); ?> flex-shrink-0"><?php echo e(ucfirst($meeting->status)); ?></span>
        </div>
        <div class="grid grid-cols-3 gap-3 mt-4 pt-4" style="border-top:1px solid var(--border-color);">
            <div class="gaming-card-flat p-3"><p class="text-xs mb-1" style="color:var(--text-muted);">Tanggal</p><p class="text-sm font-semibold" style="color:var(--text-primary);"><?php echo e($meeting->meeting_date->format('d M Y')); ?></p></div>
            <div class="gaming-card-flat p-3"><p class="text-xs mb-1" style="color:var(--text-muted);">Waktu</p><p class="text-sm font-semibold" style="color:var(--text-primary);"><?php echo e(substr($meeting->start_time,0,5)); ?> – <?php echo e(substr($meeting->end_time,0,5)); ?></p></div>
            <div class="gaming-card-flat p-3"><p class="text-xs mb-1" style="color:var(--text-muted);">Ruangan</p><p class="text-sm font-semibold" style="color:var(--text-primary);"><?php echo e($meeting->room->name); ?></p></div>
        </div>
        <?php if($meeting->teams->count()): ?>
        <div class="mt-3 pt-3" style="border-top:1px solid var(--border-color);">
            <p class="text-xs mb-2" style="color:var(--text-muted);">Tim Tambahan</p>
            <div class="flex flex-wrap gap-1.5"><?php $__currentLoopData = $meeting->teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span class="badge badge-blue"><?php echo e($t->name); ?></span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
        </div>
        <?php endif; ?>
    </div>
    ...
    <div class="gaming-card p-6">
        ...
        <div class="space-y-3">
            <?php $__currentLoopData = ['why'=>'WHY — Alasan','what'=>'WHAT — Yang Dibahas','how_expected'=>'HOW — Hasil yang Diharapkan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if($meeting->assets->count()): ?>
    <div class="gaming-card p-6">
        <h3 class="font-gaming font-semibold mb-3" style="color:var(--text-primary);letter-spacing:0.05em;">ASET DIBUTUHKAN</h3>
        <div class="flex flex-wrap gap-2"><?php $__currentLoopData = $meeting->assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><span class="badge badge-cyan"><?php echo e($a->name); ?> (<?php echo e($a->pivot->quantity); ?>)</span><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></div>
    </div>
    <?php endif; ?>
    ...
    <div class="gaming-card p-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.meetings.approve', $meeting)); ?>" class="mb-4">
            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
            <button class="btn btn-success">✓ Setujui Meeting</button>
        </form>
        <form method="POST" action="<?php echo e(route('admin.meetings.reject', $meeting)); ?>">
            <?php echo csrf_field(); ?> <?php echo method_field('PATCH'); ?>
    ...
    <div class="gaming-card p-6" style="border-color:rgba(16,185,129,0.3);background:rgba(16,185,129,0.03);">
        <div class="flex items-center justify-between gap-3 mb-4">
            ...
            <span class="badge <?php echo e($meeting->mom->status === 'sent' ? 'badge-green' : 'badge-yellow'); ?> flex-shrink-0">
                <?php echo e($meeting->mom->status === 'sent' ? 'Terkirim' : 'Draft'); ?>
    ...
    <a href="<?php echo e(route('admin.meetings.index')); ?>" class="inline-flex items-center gap-1.5 text-sm" style="color:var(--text-muted);">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\backend-johenofficesystem\resources\views\admin\meetings\show.blade.php ENDPATH**/ ?>